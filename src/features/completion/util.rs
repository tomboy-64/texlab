...
pub fn current_word(ctx: &FeatureContext<CompletionParams>) -> Option<Cow<str>> {
...
fn supports_images(ctx: &FeatureContext<CompletionParams>) -> bool {
